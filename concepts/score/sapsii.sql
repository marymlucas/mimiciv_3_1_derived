...
, vital AS (
    ...
    FROM co
    LEFT JOIN `mymimiciv.mimiciv_3_1_derived.vitalsign` vital
...
, uo AS (
    ...
    FROM co
    LEFT JOIN `mymimiciv.mimiciv_3_1_derived.urine_output` uo
...
, labs AS (
    ...
    FROM co
    LEFT JOIN `mymimiciv.mimiciv_3_1_derived.chemistry` labs
...
, cohort AS (
    ...
    LEFT JOIN `mymimiciv.mimiciv_3_1_derived.age` va
